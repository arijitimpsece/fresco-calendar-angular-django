...
export class HolidayService {
    ...
    private monthViewUpdate: Subject<void> = new Subject<void>();
    ...
    signIn(username: string, password: string): Observable<any> {
        ...
        const req = new HttpRequest("POST", url, { admin_email: username, password: password });
    ...
    addHoliday(date: string, city: string, holidayName: string): Observable<any> {
        ...
        const req = new HttpRequest("POST", "api/create/", {
            date: formattedDate,
            city_name: city,
